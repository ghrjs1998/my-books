        ...
        <div className={styles.tooltips}>
            <Tooltip title={url}>
                <a href={url} rel="noreferrer" target="_BLANK" className={styles.link_url}>
                    <Button size="small" shape="circle" icon={<HomeOutlined />} className={styles.button_url} />
                </a>
            </Tooltip>
            <Tooltip title="Edit">
                    <Button size="small" type="primary" shape="circle" icon={<EditOutlined />} className={styles.button_edit} />
            </Tooltip>
